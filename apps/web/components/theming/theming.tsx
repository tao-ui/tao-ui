        ...
        <div className="flex gap-4">
          <section className="w-full lg:w-1/2 xl:w-3/5">
            <Tabs defaultValue="tab1">
              ...
              <TabsContent value="tab1" bg="bg-level-2/70" className="p-4">
                <ColorScales>
              ...
              <TabsContent className="!bg-level-2/70 p-4" value="tab2">
                Content 2
              </TabsContent>
              <TabsContent className="!bg-level-2/70 p-4" value="tab3">
                Content 3
              </TabsContent>
              <TabsContent className="!bg-level-2/70 p-4" value="tab4">
                Content 4
              </TabsContent>
            </Tabs>
          </section>
          <aside className="hidden w-1/2 rounded-area bg-level-2/70 p-4 !pt-0 shadow-area lg:block xl:w-2/5">
            <Controls>
