...
>(({ className, ...props }, ref) => (
  <DrawerPrimitive.Overlay ref={ref} className={clsx("bg-black/80 fixed inset-0 z-50", className)} {...props} />
));
...
>(({ className, children, ...props }, ref) => (
  <DrawerPortal>
    ...
    <DrawerPrimitive.Content
      ref={ref}
      className={clsx(" fixed right-0 top-0 z-50 h-full  w-1/2 rounded-t-[10px] bg-surface", className)}
      {...props}
    >
